...
// const connection = mysql.createConnection({ host: 'handshake.chhilor2hpzo.us-east-1.rds.amazonaws.com',port :3306, user: 'root', password: 'admin123',database: 'handshake' });
